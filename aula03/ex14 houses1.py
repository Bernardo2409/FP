...
def rect(t, x, y, width, height):
    ...
    t.goto(x, y)
    t.goto(x+width/3,y)
    t.goto(x+width/3,y+height/2)
    t.goto(x+width/3*2,y+height/2)
    t.goto(x+width/3*2,y)
    t.up()
    t.goto(x+width/3,y+height/1.5)
    t.down()
    t.goto(x+width/3*2,y+height/1.5)
    t.goto(x+width/3*2,y+height/1.1)
    t.goto(x+width/3,y+height/1.1)
    t.goto(x+width/3,y+height/1.5)
    t.up()
